...
STRING_SESSION6 = getenv("STRING_SESSION1", "")
STRING_SESSION7 = getenv("STRING_SESSION2", "")
STRING_SESSION8 = getenv("STRING_SESSION3", "")
STRING_SESSION9 = getenv("STRING_SESSION4", "")
STRING_SESSION10 = getenv("STRING_SESSION5", "")
